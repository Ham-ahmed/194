...
echo -e "${CYAN}"
echo "################################################################"
echo "# Start downloading and installing  powercam-oscam_11950-r802  #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/194/refs/heads/main/enigma2-plugin-softcams-powercam-oscam_11950-emu-r802_all.ipk"
IPK_NAME="enigma2-plugin-softcams-powercam-oscam_11950-emu-r802_all.ipk"
