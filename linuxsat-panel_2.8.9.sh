...
echo -e "${CYAN}"
echo "################################################################"
echo "#     Start downloading and installing linuxsat-panel_2.8.9    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/194/refs/heads/main/enigma2-plugin-extensions-linuxsat-panel_2.8.9_all.ipk"
IPK_NAME="enigma2-plugin-extensions-linuxsat-panel_2.8.9_all.ipk"
