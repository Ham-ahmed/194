...
echo -e "${CYAN}"
echo "################################################################"
echo "#     Start downloading and installing subssupport_1.8.0-r7    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/194/refs/heads/main/enigma2-plugin-extensions-subssupport_1.8.0-r7-py3_all.ipk"
IPK_NAME="enigma2-plugin-extensions-subssupport_1.8.0-r7-py3_all.ipk"
